...
class BinarySearchTree {
    ...
    contains(searchVal) {
        ...
        var leftPoint = this.left;
        var rightPoint = this.right;

        if(this.data != searchVal)

        while(leftPoint.data != searchVal || rightPoint.data != searchVal){
            leftPoint.left;
            console.log("LP= " + leftPoint);
            rightPoint.right;
            console.log("RP= " + rightPoint);
        }
    }
